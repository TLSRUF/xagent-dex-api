"""XRP → USD OfferCreate 트랜잭션 제출 (최종 버전 - 디버그 출력 제거)"""
...
def submit_xrp_to_usd_swap(
    ...
    """
    XRP → USD OfferCreate 트랜잭션 제출 (디버그 출력 없음)
